                ...
                <div class="row">
                    <div class="col-lg-5 col-12">
                        <div class="item-bootcamp">
                            <img src="{{ asset('laracamp/assets/images/item_bootcamp.png')}}" alt="" class="cover">
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id)}}" class="basic-form" method="post">
                            ...
                            <div class="mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="cvc" type="number" class="form-control" value="value="{{old('cvc') ?: ''}}"/>
                                        @if ($errors->has('cvc'))
                            ...
                            <p class="text-center subheader mt-4">
                                <img src="{{ asset('laracamp/assets/images/ic_secure.svg')}}" alt=""> Your payment is secure and encrypted.
                            </p>
                        </form>
                    </div>
                </div>
